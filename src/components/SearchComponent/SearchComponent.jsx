                    ...
                    <div className="search__wrap">
                        <select className='search__select'>
                            <select className='search__select' name="category">
                                ...
                                <option value="automotive" name="automotive">Automotive</option>
                                <option value="environmental" name="environmental">Environmental</option>
                                <option value="financial-services" name="financial-services">Financial Services</option>
                                <option value="gaming" name="gaming">Gaming</option>
                                <option value="healthcare-life-sciences" name="healthcare-life-sciences">Healthcare & Life Sciences</option>
                                <option value="manufacturing" name="manufacturing">Manufacturing</option>
                                <option value="media-entertainment" name="media-entertainment">Media & Entertainment</option>
                                <option value="public-sector" name="public-sector">Public Sector</option>
                                <option value="resources" name="resources">Resources</option>

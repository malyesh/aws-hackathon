  ...
  return (
    <section className='main'>
      ...
      <div className='main__body--section'>
        <div
          className={`main--section__header ${
            tour.tour && tour.step === 2 ? 'tour-highlight' : ''
          }`}
        >
        ...
        <div ref={scrollDiv}>
          <div
            className={`main--section__header  ${
              tour.tour && tour.step === 3 ? 'tour-highlight' : ''
            }`}
          >
          ...
          {tour.tour && tour.step === 3 ? (
            ...
            >
              <p className='tour-step__p'>
                And here, an A.I. returns search results whose context
                correlates with the original query based on context and current
                events!
              </p>
              <p className='tour-step__p'>Thanks for taking the tour!</p>
      ...
      {tour.tour && tour.step === 2 ? (
        <div className='tour-step' style={{ bottom: '100%', left: '0' }}>
          <p className='tour-step__p'>
          ...
          {tour.tour && tour.step > 1 ? (
            <button onClick={handleTourReverse} className='demo-modal__close'>
              previous
            </button>
          ) : null}
          <button onClick={handleTour} className='demo-modal__close'>
